...
void BulletScene::setup()
{
  ...
  ground->create( world.world, ofVec3f(0., 5.5, 0.), 0., 150., 1.f, 50.f );
...
void BulletScene::drawImGui()
{
}


void BulletScene::add() {
  ...
  const float rsize = ofRandom(.15, .3);
  ofVec3f diff;
  if(shapes.size() < 2) {
